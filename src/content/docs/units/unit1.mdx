...
Este es un tutorial interactivo donde exploraremos las transformaciones básicas en el contexto de p5.js. Sigue los pasos y observa cómo el código cambia a medida que avanzas.
